...
const AlbumCover = (props: Props): JSX.Element => (
	<div className="record-cover">
		<div className="record-player-content">
			<img data-testid="cover-img" className="record-cover-image" src={props.album.images[0].url} alt="cover" />
		...
		<span className="record-cover-tracks" data-testid="cover-tracks">
			Tracks: {props.album.total_tracks}
		</span>
	</div>
);
